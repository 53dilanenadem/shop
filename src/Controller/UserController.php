...
class Usercontroller
{
	...
	public function getAll(bool $joinRole = false)
	{
		...
		$select = "SELECT u.id AS User_id, u.first_name AS User_first_name,
		 u.last_name AS User_last_name, u.email AS User_email, 
		 u.username AS User_username, u.pwd AS User_pwd, 
		 u.phone_number AS User_phone_number, u.role_id AS User_role_id,
	...
	public function countAll(): int
	{
		...
		$sql = "SELECT COUNT(*) AS count FROM user u WHERE u.etat = ?";
	...
	public function getById($id, bool $bypass = false): ?User
	{
		...
		$sql = "SELECT u.id AS User_id, u.first_name AS User_first_name,
		 u.last_name AS User_last_name, u.email AS User_email,
		  u.username AS User_username, u.pwd AS User_pwd,
		  u.phone_number AS User_phone_number,u.roler_id AS User_roler_id,
		  u.shup_id AS User_shup_id, u.adress_user AS User_adress_user,  
		  r.id AS Roler_id, r.code AS Roler_code, r.name AS Roler_name
			FROM user u 
	...
	public function toEntity(array $data): ?User
	{
		...
		$password = !empty($data['password']) ? (new PwdHasher())->hash(htmlentities($data['password'])) : null;
